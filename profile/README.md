...
BRMSTE-SB is **OPEN ALL** — every repository in this organization is **public** and **free and open for the world** under [carbon justice](https://github.com/BRMSTE-SB/.github/blob/main/CARBON-JUSTICE.md).

| Lane | Visibility | Status |
|------|------------|--------|
| **OPEN ALL** | Public (7 repos) | [Verified manifest](https://github.com/BRMSTE-SB/.github/blob/main/docs/OPEN-ALL.md) · `bash scripts/verify-open-all.sh` |
| **Enterprise Fort Knox** | Private (enterprise) | Production IP outside this org listing — [brmste-ltd enterprise](https://github.com/enterprises/brmste-ltd) |

## Carbon justice · free and open for the world

**Cursor · Claude · OpenAI · Grok · SARVAM BY BRMSTE! · every connected MCP · every datacentre and cloud · all social media** — **no BRMSTE charges** on the human-open lane. **Full free. Only carbon justice.**
