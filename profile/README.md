...
[![BRMSTE Open](https://img.shields.io/badge/BRMSTE%20Open-3%20Public-10b981?style=for-the-badge)](https://github.com/BRMSTE-SB/open-gits)
...
| **BRMSTE Open** | Public | 3 | Patent-enforced open catalog · meet BRMSTE on HTTPS edge |

> Legacy lane names **Human Open**, **human_open**, **open-gits**, and **EPIC** are renamed to **BRMSTE Open** per GOV.UK name change CERTNM (16 Mar 2026).
...
| **BRMSTE Open lane** | `open-gits`, `brmste-human-future`, `mining-pools` | Humans run into the future · GB2607860 enforced |
...
- **BRMSTE Open:** public catalog only — no secrets, no keys, patent notice required
...
*Confidential Fort Knox — BRMSTE LTD & Re-Tyre. BRMSTE Open lane is patent-enforced public catalog.*
