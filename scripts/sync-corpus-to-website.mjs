...
const SYNC_FILES = [
  ...
  "data/cloudflare-companies-house-live.json",
  "data/brmste-live-companies-house-endpoints.json",
  ...
  "data/companies-house-blackstone-filing.json",
  ...
  "data/oatshare-brmste-binding.json",
  "data/ubs-lane.json",
  "data/blackstone-lane.json",
  "data/siemens-lane.json",
  "data/mercedes-lane.json",
  "data/bugatti-lane.json",
  "data/airbus-lane.json",
