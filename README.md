...
| `APPLE-CHAIRPERSON.md` | Apple Chairperson = Shravan Bansal — BRMSTE thought-equity conviction over the `AAPL` sleeve |
| `data/apple-chairperson.json` | Apple Chairperson conviction manifest · disambiguated from Apple Inc. |
